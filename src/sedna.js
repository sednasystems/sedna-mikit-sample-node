...
const blocks = [
  {
    ...
    id: "todoName",
    label: "To-Do Name",
    value: process.env.IS_ERROR
      ? "This is a very long to-do name which will fail validation..."
      : "A normal length title",
...
const payload = {
  ...
  message: {
    ...
    bcc: [],
    href:
      "https://sedna-tst-test1.stage3systems.net/platform/2019-01-01/message/55570",
    jobReferences: [],
    categories: [],
    teams: [
      {
        ...
        name: "Head Office",
        href:
          "https://sedna-tst-test1.stage3systems.net/platform/2019-01-01/team/91",
      },
    ],
  },
  user: {
    id: "87",
    href:
      "https://sedna-tst-test1.stage3systems.net/platform/2019-01-01/user/87",
  },
  version: "2020-07-07",
};
...
const authHeader = process.env.IS_AUTHENTICATED
  ? "Bearer abc123"
  : "Bearer invalid";
const options = {
  hostname: "localhost",
